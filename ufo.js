var starttime = 3000; // czas po jakim gra siê w³±cza w milisekundach
var ufocontrol = true; // czy ma siê pojawiæ przycisk w³±cz/wy³±cz grê? true(tak) lub false(nie)
var nImpactos = 100; // maksymalna ilo¶æ punktów ognia
var nOvnis = 3; // ilo¶æ ufo
var Xpos = 0;
var Ypos = 0;
var STOPACCEL = 10;
var TAMOVNI = 20;
...
document.write('W³±cz/wy³±cz grê UFO');
document.write('</form>');
}
if (isNetscape) {
startanimate();
